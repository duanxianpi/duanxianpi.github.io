    ...
    return (
        <div className={style.container}>
          <div style={{textAlign: "left"}}>
            ...
            <h1 style={{fontSize:"72px", fontWeight: "bold",color:"#353A42", margin: "0"}}>Peter Duan</h1>
            <h1 style={{fontSize:"72px", fontWeight: "bold",color:"#00112B", marginTop: "5px"}}>Exploring, Learning, Progressing</h1>
            <ConfigProvider
            theme={{
                token: {
